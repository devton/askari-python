...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'user_profile_userprofile_organizations')
        ...
        db.create_unique(m2m_table_name, ['userprofile_id', 'organization_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'user_profile_userprofile_organizations'))
    ...
    models = {
        ...
        u'user_profile.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organizations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['organizations.Organization']", 'null': 'True', 'blank': 'True'}),
