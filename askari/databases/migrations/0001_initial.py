...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'databases_database', (
            ...
            ('db_user', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('db_password', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('db_engine', self.gf('django.db.models.fields.CharField')(max_length=255)),
