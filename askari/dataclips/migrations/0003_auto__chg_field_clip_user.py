...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Clip.user'
        db.alter_column(u'dataclips_clip', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.DO_NOTHING))

    def backwards(self, orm):

        # Changing field 'Clip.user'
        db.alter_column(u'dataclips_clip', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
